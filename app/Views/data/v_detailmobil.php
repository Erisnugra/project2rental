				...
				<div class="col-sm-8">
					<div class="card shadow">
						<div class="card-header">
							<h6 class="m-0 font-weight-bold text-primary">Detail Mobil - <?= $data->nama_mobil; ?></h6>
						</div>

						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
									<img src="<?= base_url('foto_mobil/' . $data->gambar) ?>" alt="Suzuki All New Ertiga" class="img-thumbnail mb-4">
								</div>
								<div class="col-md-6">
									<table class="table table-borderless">
										<tr>
											<td>Nama</td>
											<td>:</td>
											<td><b><?= $data->nama_mobil; ?></b></td>
										</tr>
										<tr>
											<td>Merk</td>
											<td>:</td>
											<td><b><?= $data->nama_merk; ?></b></td>
										</tr>
										<tr>
											<td>Nomer Polisi</td>
											<td>:</td>
